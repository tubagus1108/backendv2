...
<h3>Transactions Success</h3>
@endsection

@section('breadcrumb-items')
<li class="breadcrumb-item">Transactions Success</li>
@endsection
@section('content')
...
<script>
	$(function(){
		$('#data-admin').DataTable({
			ajax: '{{route('transaction-success-admin-datatable')}}',
			columns:[
				{data: 'id',name:'id'},
		...
		$('#data-superadmin').DataTable({
			ajax: '{{route('transaction-success-superadmin-datatable')}}',
			columns:[
				{data: 'id',name:'id'},
				{data: 'datetransaction',name:'datetransaction'},
				{data: 'sender',name:'sender'},
